    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Aroma Essense uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '91a224a9-fdff-4d19-8205-12a457a2739f',
                    name: data.name || '',
                    email: data.email || '',
